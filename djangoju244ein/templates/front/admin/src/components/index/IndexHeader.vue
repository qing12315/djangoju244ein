<template>
	<div class="navbar">
		<div class="title" :style='{"width":"30%","lineHeight":"1.2","alignItems":"center","background":"none","display":"flex","order":"1"}'>
			...
			<span class="title-name" :style='{"padding":"0 0 0 12px","lineHeight":"44px","fontSize":"16px","color":"#FFFF99","float":"left","fontWeight":"500"}'>{{this.$project.projectName}}</span>
		</div>
		<!--
